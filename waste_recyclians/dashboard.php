...
<!--end post comments notifications-->
 ...
 <li class="navgate_no"><a title='Recycle New Waste' data-toggle='modal' data-target='#myModal_recycling' style="color:white;font-size:14px;">
<button class="category_post1">Recycle <br>New Waste</button></a></li>




 <li class="navgate_no"><a title='Recyclers  AI Chatbot' data-toggle='modal' data-target='#myModal_chatbot' style="color:white;font-size:14px;">
<button class="category_post1">Recyclers <br>AI Chatbot</button></a></li>



 <li class="navgate_no"><a title='Waste Recycling Companies Mapping' href="map_companies.php" style="color:white;font-size:14px;">
<button class="category_post1">Nearby Waste Recycling<br> Companies Map</button></a></li>
...
<b style='color:purple'> <?php echo $fullname_sess; ?></b>  to
 <b style='color:purple'><?php echo $title; ?></b> -- Connectng all <b style='color:purple'><?php echo $country_nickname_sess; ?></b> Recyclers with their various Waste Recycling Companies </h4></center><br>
...
<b>Addess:</b><?php echo $address; ?><br>
...
$res= $db->prepare("SELECT count(*) as totalcount FROM posts WHERE country_nickname=:country_nickname");
$res->execute(array(':country_nickname' =>$country_nickname_sess));
$t_row = $res->fetch();
$totalcount = $t_row['totalcount'];

if($totalcount == 0){
echo "<div style='background:red;color:white;padding:10px;border:none;'>No Waste Recycle Material Posted by  <b>$country_nickname_sess</b>  Yet...</div>";
//exit();
}
...
if(ai_model =='Google Gemini AI'){
				...
				$('#alerts_recycle').delay(5000).fadeOut('slow');
                                $('#alerts_recyclea').delay(5000).fadeOut('slow');
...
if(id =='1'){
$("#loader_1").fadeIn(400).html('<span style="color:black;background:#ddd;padding:4px;"><img src="loader.gif">&nbsp;Please Wait, Generating Data on How to Recycle Plastics....</span>');
...
if(id =='2'){
$("#loader_2").fadeIn(400).html('<span style="color:black;background:#ddd;padding:4px;"><img src="loader.gif">&nbsp;Please Wait, Generating Data on How to Recycle Aluminium Cans....</span>');
...
if(id =='3'){
$("#loader_3").fadeIn(400).html('<span style="color:black;background:#ddd;padding:4px;"><img src="loader.gif">&nbsp;Please Wait, Generating Data on How to Recycle Papers....</span>');
...
if(id =='4'){
$("#loader_4").fadeIn(400).html('<span style="color:black;background:#ddd;padding:4px;"><img src="loader.gif">&nbsp;Please Wait, Listing Nearby Waste Recycling Companies....</span>');
...
Easily Chat with <b>OpenAI and Google Gemini AI</b> to get more detailed insights about how to recycle various waste materials like
<b>Plastics, Aluminium Cans, Papers, Bottles, Metals,organic waste/Composts </b> etc.<br><br>
...
<div class="col-sm-6">
<h3>AI Inqury About How to Recycle Waste Materials</h3>

<span style='color:red;'> Click Any button below to Get ChatGPT or Gemini AI Responses on Waste Materials Recycling.</span><br><br>


<div class='' id="loader_1"></div>
<div class='ai_enquiry_clean ai_enquiry_clean_1' id="result_1"></div>
<div class='ai_send_btn cat_css' data-idx='1' id='1_How to Recycle Plastics. Give Full Details' >How to Recycle Plastics.</div><br>


<div class='' id="loader_2"></div>
<div class='ai_enquiry_clean ai_enquiry_clean_2' id="result_2"></div>
<div class='ai_send_btn cat_css' data-idx='2' id='2_How to Recycle Aluminium Cans. Give Full Details'>How to Recycle Aluminium Cans</div><br>

<div class='' id="loader_3"></div>
<div class='ai_enquiry_clean ai_enquiry_clean_3' id="result_3"></div>
<div class='ai_send_btn cat_css' data-idx='3' id='3_How to Recycle Papers. Give Full Details' >How to Recycle Papers</div><br>

<div class='' id="loader_4"></div>
<div class='ai_enquiry_clean ai_enquiry_clean_4' id="result_4"></div>
<div class='ai_send_btn cat_css' data-idx='4' id='4_List Waste Recycling Companies Eg in <?php echo $country_sess; ?>. Give Full Details, Their Website and URL Links if available' >

List Waste Recycling Companies Eg in <?php echo $country_sess; ?></div><br>
<br>
...
<h4 style='color:purple''>Still have further Questions about  How to Recycle Waste Materials, Chat with ChatGPT Or Google Gemini AI Now</h4>
