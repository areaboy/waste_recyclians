...
$post_userid = strip_tags($_GET['userid']);
...
$post_userid_vaidate = preg_replace("/[^a-zA-Z0-9]+/", "", $post_userid);
...
<center class='wellx'><h4>Welcome to
<b style='color:purple'> <?php echo $fullname_data; ?>'s</b>  Profile. 
</h4>

<img style="max-height:60px;max-width:60px;" class="img-rounded" width="60px" height="60px"
 src="backend/user_photos/<?php echo $photo_data; ?>" width="80px" height="80px">

<b> Total Points Earned so far by the User for Recycling Contributions:</b>  <?php echo $points_data; ?>(Points) <br>
<b> Country/Location: </b> <?php echo $country_data; ?>  
 <button  class="email_send_btn readmore_btn">Send Email to User "<?php echo $fullname_data; ?>" </button><br>
